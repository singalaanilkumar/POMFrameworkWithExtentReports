...
public class AvenstackReports implements IReporter {
    ...
    public void generateReport(List xmlSuites, List suites, String outputDirectory) {
        ...
        spark.config().setDocumentTitle("ExtentSparkReports - AutomationFramework");
        spark.config().setReportName("ExtentSparkReports - jpetStore");
